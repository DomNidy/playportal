    ...
    <div >
      ...
      <main className="w-full min-h-screen dark:bg-dark bg-gray-100 pt-14 pb-4 ">
        ...
        <div className="flex justify-center">
          <div className="pt-8 grid gap-8  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:max-w-screen-md lg:max-w-screen-lg dark:text-gray-400 text-slate-600 justify-center items-center place-items-center w-full">
            <div className="flex flex-col gap-1 p-2 items-center dark:bg-dark-container bg-gray-100  rounded-lg w-72 min-h-[14rem] h-fit shadow-md  ">
            ...
            <div className="flex flex-col gap-1 p-2 items-center dark:bg-dark-container bg-gray-100  rounded-lg w-72 min-h-[14rem] h-fit shadow-md  ">
              <h1 className="font-bold text-2xl select-none">Features</h1>
              <div className="max-w-[82%] p-1">
                <h2 className="list-item">
                  Create your own playlist portfolio
                </h2>
